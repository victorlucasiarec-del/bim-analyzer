...
const SKIP_TYPES = new Set([
  ...
  // ── Primitivos topológicos ──
  'IFCFACE', 'IFCPOLYLOOP', 'IFCFACEOUTERBOUND', 'IFCFACEBOUND',
  'IFCEDGE', 'IFCEDGELOOP', 'IFCORIENTEDEDGE', 'IFCEDGECURVE',
  'IFCVERTEX', 'IFCVERTEXPOINT', 'IFCPATH', 'IFCLOOP',
  'IFCADVANCEDFACE', 'IFCINDEXEDPOLYGONALFACE', 'IFCPOLYGONALFACE',
  // ── Sólidos e operações booleanas ──
  ...
  'IFCSECTIONEDSPINE', 'IFCPOLYGONALBOUNDEDHALFSPACE', 'IFCHALFSPACESOLID',
  // ── Shells / BREPs / Meshes ──
  'IFCCLOSEDSHELL', 'IFCOPENSHELL', 'IFCFACETEDBREP', 'IFCADVANCEDBREP',
  'IFCADVANCEDBREPWITHVOIDS', 'IFCSHELLBASEDSURFACEMODEL',
  'IFCCONNECTEDFACESET', 'IFCTRIANGULATEDFACESET',
  // ── Curvas e primitivos 1D ──
  'IFCLINE', 'IFCELLIPSE', 'IFCCIRCLE', 'IFCVECTOR',
  'IFCCOMPOSITECURVE', 'IFCCOMPOSITECURVESEGMENT', 'IFCCOMPOSITECURVEONSURF ACE',
  'IFCTRIMMEDCURVE', 'IFCBSPLINECURVE', 'IFCBSPLINECURVEWITHKNOTS',
  'IFCRATIONALSPLINECURVEWITHKNOTS', 'IFCOFFSETCURVE2D', 'IFCOFFSETCURVE3D',
  'IFCINDEXEDPOLYCURVE', 'IFCSEVENTHORDERPOLYNOMIALSPIRAL',
  // ── Superfícies ──
  'IFCPLANE', 'IFCBSPLINESURFACE', 'IFCBSPLINESURFACEWITHKNOTS',
  'IFCCYLINDRICALSURFACE', 'IFCRATIONALBSPLINESURFACEWITHKNOTS',
  // ── Perfis de seção transversal ──
  'IFCCIRCLEPROFILEDEF', 'IFCRECTANGLEPROFILEDEF', 'IFCISHAPEPROFILEDEF',
  'IFCLSHAPEPROFILEDEF', 'IFCTSHAPEPROFILEDEF', 'IFCUSHAPEPROFILEDEF',
  'IFCCHANNELPROFILEDEF', 'IFCELLIPSEPROFILEDEF', 'IFCZSHAPEPROFILEDEF',
  'IFCCSHAPEPROFILEDEF', 'IFCARBITRARYCLOSEDPROFILEDEF',
  'IFCARBITRARYOPENPROFILEDEF', 'IFCCOMPOSITEPROFILEDEF',
  'IFCASYMMETRICISHAPEPROFILEDEF', 'IFCRECTANGLEHOLLOWPROFILEDEF',
  'IFCCIRCLEPROFILEDEFWITHVOIDS', 'IFCCENTRELINEPROFILEDEF',
  ...
  'IFCGEOMETRICSET', 'IFCGEOMETRICCURVESET', 'IFCSHAPEMODEL',
  // ── Material ──
  'IFCMATERIAL', 'IFCMATERIALLAYER', 'IFCMATERIALLAYERSET',
  'IFCMATERIALLAYERSETUSAGE', 'IFCMATERIALCONSTITUENT',
  'IFCMATERIALCONSTITUENTSET', 'IFCMATERIALPROFILE', 'IFCMATERIALPROFILESET',
  'IFCMATERIALPROFILESETUSAGE', 'IFCMATERIALDEFINITIONREPRESENTATION',
  // ── Apresentação / estilo visual ──
  'IFCPRESENTATIONLAYERASSIGNMENT', 'IFCSTYLEDITEM',
  'IFCSURFACESTYLE', 'IFCSURFACESTYLERENDERING', 'IFCSURFACESTYLESHADING',
  'IFCCURVESTYLE', 'IFCTEXTSTYLE', 'IFCFILLAREASTYLE',
  'IFCCOLOURRGB', 'IFCPIXELTEXTURE', 'IFCIMAGETEXTURE',
  'IFCDRAUGHTINGPREDEFINEDCOLOUR', 'IFCDRAUGHTINGPREDEFINEDCURVEFONT',
  ...
  'IFCRELDECOMPOSES', 'IFCRELCONNECTS', 'IFCRELFLOWCONTROLLELEMENTS',
  'IFCRELNESTS', 'IFCRELCOVERSBLDGELEMENTS', 'IFCRELPROJECTSELEMENT',
  // ── Quantitativos e classificação ──
  'IFCPROPERTYBOUNDEDVALUE', 'IFCPROPERTYENUMERATEDVALUE',
  'IFCPROPERTYLISTVALUE', 'IFCPROPERTYTABLEVALUE',
  'IFCQUANTITYLENGTH', 'IFCQUANTITYAREA', 'IFCQUANTITYVOLUME',
  'IFCQUANTITYWEIGHT', 'IFCQUANTITYCOUNT', 'IFCQUANTITYTIME',
  'IFCELEMENTQUANTITY', 'IFCPHYSICALSIMPLEQUANTITY',
